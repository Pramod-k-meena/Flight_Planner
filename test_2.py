...
from fucker import Planner

def test_complex_network_cheapest_route():
    """
    ...
    Test cases focus on finding the cheapest possible routes within time constraints.
    Returns empty list [] when no route is found.
    """
    
    flights = [
        Flight(0, 0, 9999999999999999999, 0, 9999999999999999999, 9999999999999999999),
    ...
    test_scenarios = [
        ...
        },
        {
            ...
            "expected_total_cost": 250,  # NY->Denver->LA cheaper than direct
            "expected_flight_numbers": [4, 11],  
            "description": "NY to LA - Should take cheaper multi-hop over expensive direct"
        },
        
        # New complex test cases with multiple valid paths but one optimal solution
        {
            "start": 0, "end": 4, "t1": 0, "t2": 400,
            "expected_total_cost": 300,  # NY->Denver->Seattle cheapest
            "expected_flight_numbers": [4, 16],
            "description": "NY to Seattle - Multiple paths, one optimal (through Denver)"
        },
        {
    ...
    print("\nRunning complex network test scenarios for cheapest routes...")
    for scenario in test_scenarios:
        route = planner.cheapest_route(
            scenario["start"], 
            scenario["end"], 
            scenario["t1"], 
            scenario["t2"]
...
if __name__ == "__main__":
    test_complex_network_cheapest_route()