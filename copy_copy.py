...
"""This is failing for kj clauder complex test case"""
    # def least_flights_cheapest_route(self, start_city, end_city, t1, t2):
    #     if start_city == end_city:
    #         return []
    ...
    #     pq = []
    #     visited = [float('inf')] * (self.max_city + 1)
    #     pq.append((0, 0, t1, start_city, []))  # (flight_count, total_cost, last_arrival, current_city, path)
    #     visited[start_city] = 0
    #     result = []

    #     while len(pq) > 0:
    #         flight_count, total_cost, last_arrival, current_city, path = pq.pop(0)
    ...
    #                 if new_cost < visited[flight.end_city]:
    #                     visited[flight.end_city] = new_cost
    #                     pq.append((new_flight_count, new_cost, flight.arrival_time, flight.end_city, path + [flight]))
